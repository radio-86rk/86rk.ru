...
{{{:MESS(0)
<tr class=row><td>%NUM%.<td><a nickid=%NICKID%>%NICK%</a><td>%NUMERAL(%COUNT1%)% + %NUMERAL(%COUNT2%)%<div class=fright>= %NUMERAL(%COUNT12%)%</div><td>%SECRECY%%</tr>
|||
...
{{{:TIME(0)
<tr class=row><td>%NUM%.<td><a nickid=%NICKID%>%NICK%</a><td>%LONG_TIME(%TIME%, "час", "мин")%<td>%SECRECY%%</tr>
|||
<tr><td colspan=4 class=empty>никого нет</tr>
}}}
<tr><th colspan=4 class=line></tr>
...
{{{:REFERALS(0)
<tr class=row><td>%NUM%.<td nowrap><a nickid=%NICKID%>%NICK%</a><td>%REFERALS%<td>%DATE2("d mmm yyyy")%</tr>
|||
<tr><td colspan=4 class=empty>никого нет</tr>
}}}
<tr><th colspan=4 class=line></tr>
...
<tr class=th><th><th>Ник<th>Время<th>Скрытность</tr>
{{{:TIME(1)
<tr class=row><td>%NUM%.<td><a nickid=%NICKID%>%NICK%</a><td>%NUMERAL("%LONG_TIME(%TIME%, "час", "мин")%")%<td>%SECRECY%%</tr>
|||
<tr><td colspan=4 class=empty>никого нет</tr>
}}}
<tr><th colspan=4 class=line></tr>
