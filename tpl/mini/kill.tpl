...
%?<tr><th colspan=2>Пользователи этого же прокси</th></tr>%PROXY_LIST%?%
%?<tr><th colspan=2>Пользователи с таким же IP</th></tr>%IP_LIST%?%
%?<tr><th colspan=2>Пользователи из той же сети</th></tr>%NET_LIST%?%
%?<tr><th colspan=2>Пользователи этого же компьютера</th></tr>%CID1_LIST%?%
%?<tr><th colspan=2>Пользователи похожего компьютера</th></tr>%CID2_LIST%?%
</table>
<br>
