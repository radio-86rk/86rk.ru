...
<tr>
<td>Доступ на запись сообщений:</td>
<td>
%radio("AccessWrite", %AccessWrite%, { 0: "доступно всем", 1: "только зарегистрированным", "-1": "доступ закрыт" })%
%?
<h4 class=group>доступ открыт только группе:</h4>
%radio("AccessWrite", %AccessWrite%, %?%GROUPLIST("%GROUP_NAME% (%GROUP_COUNT%)")%?%)%
?%
</td>
</tr>
<tr>
<td>Порядок сообщений:</td>
<td>%radio("MessDir", %MessDir%, ["обратный (новые первые)", "прямой (новые последние)"])%</td>
</tr>
<tr>
<td>Смайлики в сообщениях:</td>
<td>
...
<td>%input("MaxMessLen", %MaxMessLen%, 5, 6)% символов</td>
</tr>
<tr>
...
<td>%checkbox("Bubble", %Bubble%, 1, "всплывающие сообщения")%</td>
</tr>
<tr>
...
<hr>
%button("cfg_wall_save", "OK", "", "class=w100")%
